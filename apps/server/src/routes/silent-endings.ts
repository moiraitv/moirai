...
import { silentEndingAcceptanceSchema, scanHistorySchema } from '@moirai/shared/api-contracts';
...
/** Record reversible acceptance for the current file and publish its revised library health. */
