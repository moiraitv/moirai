ALTER TABLE credit_templates ADD COLUMN description TEXT NOT NULL DEFAULT '';
--> statement-breakpoint
ALTER TABLE credit_templates ADD COLUMN is_builtin INTEGER NOT NULL DEFAULT 0;
--> statement-breakpoint
WITH RECURSIVE candidates(n, name) AS (
 ...
 SELECT 1 FROM credit_templates WHERE name_key = lower(candidates.name)
 ) ORDER BY n LIMIT 1
)
INSERT INTO credit_templates (id, name, name_key, description, source, is_builtin, created_at, updated_at)
SELECT '20000000-0000-4000-8000-000000000001', name, lower(name), 'Artist, song, and album credits at the beginning and end of music videos.', '[Script Info]
ScriptType: v4.00+
WrapStyle: 0
...
{% endfor %}
', 1,
 '2026-09-09T00:00:00Z', '2026-09-09T00:00:00Z' FROM available;
